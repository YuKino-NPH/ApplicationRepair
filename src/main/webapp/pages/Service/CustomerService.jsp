            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal">
                   ...
                   <%-- <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            &lt;%&ndash; 下拉列表，部门选项只要提交部门id即可 &ndash;%&gt;
                            <select class="form-control" name="dId" id="_select"></select>
                        </div>
                    </div>--%>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <%-- 下拉列表，部门选项只要提交部门id即可 --%>
                            <select class="form-control" name="rName" id="repair_select"></select>
                        </div>
                    </div>
                </form>
                <%------------------------------------------------------------------%>
...
<script type="text/javascript">
    ...
    $("#emp_add_modal_btn").click(function () {
        ...
        getServices("#empAddModal select");
        //弹出模态框
        $("#empAddModal").modal({
            backdrop: "static"
        });
    ...
    function getServices(ele) {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                //遍历部门信息，在下拉列表中显示部门信息
                $.each(res.extendMap.repairs, function () {
                    //在遍历之前
                    var optionEle = $("<option></option>").append(this.rName).attr("value", this.rId);
    ...
    $(document).on("click", ".edit_btn", function () {
        ...
        //2、查出部门信息，并显示部门列表
        getServices("#empUpdateModal select");
        //弹出模态框，
    ...
    $("#emp_update_btn").click(function () {
        ...
        $.ajax({
            ...
            url: "CustService/" + $(this).attr("edit-id"),
            type: "PUT",
            data: "rName="+$("#empUpdateModal form select").find("option:selected").text(),// + "&_method=PUT",
            success: function (res) {
                 //alert(res.msg);
                //关闭对话框
